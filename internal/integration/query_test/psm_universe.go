...
func NewFooUniverse(t *testing.T, opts ...universeOption) (*flowtest.Stepper[*testing.T], *FooUniverse) {
	t.Helper()
...
func (uu *FooUniverse) ListFoo(t flowtest.Asserter, req *test_spb.FooListRequest) *test_spb.FooListResponse {
	t.Helper()
